        ...
        <ul class="navbar-nav justify-content-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="genreMovies.php?id=18">Drama</a></
        ...
        <ul class="nav navbar-nav w-100 justify-content-end">
          ...
          <div data-mdb-input-init class="form-outline  me-3 ">
            <form action="searchMovies.php" id="search-moviess" method="get">
              <input type="text" class="form-control ps-5 rounded-pill" placeholder="Search Films" name="query"
                style="max-width:200px;" />
              <i class="bi-search ms-3"></i>
            </form>
          </div>
          <div data-mdb-input-init class="form-outline  me-3">
            <form action="searchActor.php" id="search-acteurs" method="get">
              <input type="text" class="form-control ps-5 rounded-pill " placeholder="Search Acteurs" name="query"
                style="max-width:200px;" />
              <i class="bi-search ms-3"></i>
            </form>
          </div>
